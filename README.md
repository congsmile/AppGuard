...
- **场景化裁决与合规豁免机制**：
  - **合理业务场景豁免回补**：如核实目标应用申报为浏览器或下载工具，其原生下载调度属于基本功能服务所必需，智能体依据国家四部委《规定》第3条第(32)项给予全额场景豁免并回补得分（+5分）；
...
- **双驱动混合推理架构**：
  ...
  - **法理意见书与可落地代码级 Patch**：输出权威法律条文依据（《个人信息保护法》第六条最小必要原则、第十七条告知义务，以及工信部26号文）、调用成因深度剖析，以及开箱即用的 Java/Kotlin 合规整改代码。
